...
export const GlobalChatbot: React.FC = () => {
  ...
  const [messages, setMessages] = useState<{role: 'user'|'bot', text: string}[]>([
    { role: 'bot', text: 'Hi! I am the NYT Flow AI Assistant. I can help you understand grading rubrics, predict project risks, or navigate your dashboard based on the curriculum guidelines. How can I help?' }
  ]);
      ...
      <Card elevation={3} style={{ 
          ...
          <div style={{ padding: '16px', backgroundColor: 'var(--primary)', color: 'white', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
             <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                <Bot size={20} />
                <span style={{ fontWeight: 600 }}>Groq AI Assistant</span>
             </div>
